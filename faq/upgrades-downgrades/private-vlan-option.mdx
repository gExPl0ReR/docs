...
description: "Set up and configure a Private VLAN on your EDIS Global VPS for secure internal networking between servers. Step-by-step ordering and configuration guide."
---
...
- **VLAN Isolation**: A unique VLAN ID ensures that only VPS mapped to the same VLAN can communicate with each other through the private network you configure.
...
3. **Payment and Provisioning**: Once you pay the invoice, we automatically provision the Private VLAN option and make it available for all VPS in the chosen location.
