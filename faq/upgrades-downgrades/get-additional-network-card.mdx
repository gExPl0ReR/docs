...
description: "Add a second NIC to your EDIS Global VPS to enable Private VLAN networking. Step-by-step guide to ordering, configuring, and using the secondary interface."
---

## Add additional NIC to your VPS

## What is a secondary network interface?
...
2. **Select the Server Location**: Make sure to select the correct location where your VPS is hosted.
