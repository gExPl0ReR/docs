...
- You can purchase a **second network interface** to enhance networking capabilities.
...
1. **Go to the Order Page**: [EDIS Global Private VLAN Option](https://manage.edisglobal.com/cart.php?gid=209)
...
2. Assign an IP address to `eth1`, such as `192.168.1.10` or any private/public IP you have.
3. Restart your VPS to detect the new interface.
...
## Final Notes
Ensure that you select the correct location for the secondary network interface.
