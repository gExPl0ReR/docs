...
description: "Confirm Windows recognizes all CPU cores assigned to your VPS using Task Manager, msinfo32, and PowerShell. Verify core count and tune performance settings."
sidebarTitle: Check CPU Cores on Windows
---

import { CtaButton } from "/snippets/cta-button.mdx";

## How to check the number of CPU cores available to Windows
