...
slug: understanding-cpu-cores-vs-sockets-in-vps
...
createdAt: Fri Oct 20 2023 06:26:20 GMT+0000 (Coordinated Universal Time)
updatedAt: Tue Aug 06 2024 11:51:38 GMT+0000 (Coordinated Universal Time)
---
...
<CtaButton
  label='fast forward to guide'
  link='#3-adjusting-cpu-settings-in-kvm-management-dashboard'
/>
...
![](/assets/huaNpFAxK5PVCl_NLo3ID-iETZNYThaffnYenRdYUNi-20240806-114520.png)

1. Navigate to your <a href="https://manage.edisglobal.com/clientarea.php" target="_blank">VPS Management Portal</a>
...
![](/assets/huaNpFAxK5PVCl_NLo3ID-tcYuoIemRB1MLqTyqaz6a-20240806-114542.png)
...
<CtaButton
  label='Check CPU Cores on a Windows VPS'
  link='./how-to-check-cpu-cores-windows-vps'
/>
