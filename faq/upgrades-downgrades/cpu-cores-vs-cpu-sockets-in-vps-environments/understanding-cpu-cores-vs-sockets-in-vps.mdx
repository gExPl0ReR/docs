...
description: "How CPU cores differ from CPU sockets in a VPS environment, why virtualization exposes both, and how to adjust the layout in the VPS Management Portal."
sidebarTitle: Understanding CPU Cores vs. Sockets
---
...
<CtaButton label="fast forward to guide" link="#3-adjusting-cpu-settings-in-vps-management-portal" />
...
3. Click **KVM Settings**

4. Within the settings, you'll find options to switch between "multiple sockets" and "multiple cores".

5. Select the desired configuration based on your requirements.

6. Power-cycle your VPS (shutdown in the OS, power off, power-on)
