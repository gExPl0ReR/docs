...
- SMTP traffic is **rate-limited to 8 packets per second (pps)**, with an **initial burst of 16 pps**. This is more than enough for standard email usage and swift outbound email delivery.
