...
description: "Deploy Windows RDP on your EDIS VPS with 1-click install. Windows Server 2019, 2022, 2025, and Windows 10 / 11. Trial license included, port 3389."
...
- Windows Server 2025 (180-day trial)
- Windows 10 (90-day trial)
- Windows 11 (90-day trial)

![Windows RDP Service available?](/assets/windows-rdp-app-on-mac.png)

After the installation completes (we install from scratch, so **it only takes about 15 minutes** to finish a Windows Server setup), you'll receive a fully working Windows environment.  
