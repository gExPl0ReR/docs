...
og:description: This guide shows how to get more IP addresses for a VPS. The standard service gives a random IP, but for an extra fee, the premium service lets you pick your prefix and IP from a provided list.
---
