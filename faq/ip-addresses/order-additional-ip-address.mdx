...
description: "Order additional, randomly assigned IPv4 addresses for your EDIS Global VPS. Step-by-step guide covering pricing, ordering, and assignment to your server."
---
...
If you are interested in adding IP addresses to your VPS
...
Our system will guide you through the ordering, checkout and payment process.

Once the payment has gone through, our system will provision an additional, randomly assigned IPv4 address to your service. After provisioning, all IP addresses will be displayed in the VPS Management Portal. 
