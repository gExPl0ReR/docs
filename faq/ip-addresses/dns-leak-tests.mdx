---
title: "DNS Leak Tests and Anycast DNS on EDIS Global VPS"
description: "Why DNS leak tests may show unexpected DNS server locations on an EDIS Global VPS, how Anycast DNS works, and why this does not change your geo-location."
...
Your **VPS IP address** is what defines your geo-location, not where DNS queries are resolved.
...
#### 🔑 But remember:
> **The goal of DNS leak tests is to detect if DNS requests are leaking outside your secure environment (like a VPN), not to determine geo-location accuracy.**
