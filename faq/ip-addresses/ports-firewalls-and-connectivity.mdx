...
<Note>
  **Exception: Port 25 (SMTP).** Outbound traffic on port `25` is rate-limited by default. We apply this rate limit to protect both our network and our customers from the negative impacts of spamming activities. For details and how to request a higher limit, see the [Port 25 SMTP Rate Limit Policy](/faq/port-25-smtp-rate-limit-policy#port-25-smtp-rate-limit-policy).
</Note>
