---
title: "How to use the EDIS Global Free Latency Test"
...
The **EDIS Global Free Latency Test** allows you to measure ping times from your device to VPS hosting locations worldwide. It helps you identify which server location will provide the **best responsiveness for your connection**.
...
Because of this, **run latency tests from the same network where you will use the VPS**.
