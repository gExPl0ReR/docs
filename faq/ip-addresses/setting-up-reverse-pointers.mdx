...
description: "Configure reverse DNS (PTR) records for IPv4 and IPv6 addresses through the EDIS Global KVM management portal. Step-by-step guide for mail and SSL setup."
---
