...
description: EDIS prioritizes precise GEO localization of its VPS services, which are hosted exactly at the indicated server location and connected to the Internet via international upstream providers and local Internet Exchanges.
---
...
Results may **sometimes include a country field**, but it’s **not based on GeoIP lookup**!
