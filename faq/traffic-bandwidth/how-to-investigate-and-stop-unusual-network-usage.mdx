...
For example, a process like `xray-linux-amd6` with PID `28799` is making outbound connections to multiple external IPs. This is a strong sign of a background service or script consuming network bandwidth.
...
- **If you get a “mount point not mounted” error:**  
