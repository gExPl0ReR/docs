...
### **4. Use the Correct Code Block**

Ensure that you're **using backticks (\`) for the code block**, and **not mixing spaces or tabs** incorrectly.

### **5. Use Mintlify's Mermaid Component**

Some versions of Mintlify may require wrapping the diagram with their **Mermaid component**:
