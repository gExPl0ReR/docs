...
If your service is suspended for non-payment, it will automatically reactivate once an invoice gets paid. Once an invoice shows _cancelled_, it can no longer be paid, the service no longer exists.
