...
EDIS Global supports one-off and recurring payments through world's leading **Credit Cards**

American Express, China UnionPay (CUP), Discover & Diners, Japan Credit Bureau (JCB), Mastercard, VISA.

Credit card transactions are processed via Stripe.  Please note that **cards issued by Russian banks are not supported due to international sanctions and payment network restrictions**. Chinese Union Pay cards are working normally.
...
**Monero (XMR)** is a privacy-centric cryptocurrency that offers untraceable and anonymous transactions, providing a significant advantage in the digital currency space by not recording transaction details, unlike Bitcoin. Mobile Payment Technologies
