...
description: "How currency conversion works on EDIS Global payments. Prices are in EUR with automatic conversion when paying by credit card, PayPal, or cryptocurrency."
---
...
- **Your bank or card issuer** determines the exchange rate and any applicable conversion fees.

## PayPal payments
- If you select **PayPal**, the PayPal payment dialogue will display the amount in your **account currency**, and in **EUR (€)** right below.
...
- When selecting **Cryptocurrency as your payment method**, you simply select **the crypto you want to pay with (e.g., Bitcoin, Ethereum, USDT, etc.)**.  
