...
If your VPS has been terminated, but your invoice is **UNAPID (not yet cancelled)**, there may be an opportunity to restore your data. To attempt recovery:
...
flowchart TD
    ...
    subgraph recovery["🔄 Service Recovery"]
        direction TB
    ...
    subgraph no_recovery["⚠️ Recovery No Longer Possible"]
        direction TB
        X["🛑 Data Permanently Lost"]
    end

    E -.->|Invoice UNPAID| R1 --> R2 --> R3
