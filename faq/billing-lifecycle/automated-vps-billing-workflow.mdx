...
flowchart TD
    ...
    subgraph recovery["🔄 Service Recovery (If Invoice NOT YET Cancelled)"]
        direction TB
        R1["💰 Make Payment"]
        R2["📞 Contact Support"]
    ...
    subgraph no_recovery["⚠️ No Data Recovery Possible (If Invoice already Cancelled)"]
        direction TB
        X["🛑 Data Permanently Lost"]
    end

    E -.->|Invoice NOT YET Cancelled| R1 --> R2 --> R3
