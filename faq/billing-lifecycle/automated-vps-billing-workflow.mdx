...
![invoice status unpaid, service can be recovered](/assets/invoice-status-unpaid-cropped.webp)
...
![invoice status cancelled, service can no longer be recovered](/assets/invoice-status-cancelled-cropped.webp)
