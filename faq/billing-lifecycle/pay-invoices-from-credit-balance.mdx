...
After topping up your account balance, you can use your account credit to pay invoices. EDIS Global automatically applies available account credit to all **newly generated renewal invoices**. Account credit is also available as a payment method during checkout when placing new orders.
