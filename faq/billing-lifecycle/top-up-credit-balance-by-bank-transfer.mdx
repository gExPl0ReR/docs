...
>
  <a
    ...
    onClick={(e) => {
      e.preventDefault();
      fetch("/assets/EDGBL-LTD-EUR_iBanFirst.pdf")
        .then((response) => response.blob())
        .then((blob) => {
          const url = window.URL.createObjectURL(blob);
          const a = document.createElement("a");
          a.href = url;
          a.download = "EDGBL-LTD-EUR_iBanFirst.pdf";
  ...
  <a
    ...
    onClick={(e) => {
      e.preventDefault();
      fetch("/assets/EDGBL-LTD-USD_iBanFirst.pdf")
        .then((response) => response.blob())
        .then((blob) => {
          const url = window.URL.createObjectURL(blob);
          const a = document.createElement("a");
          a.href = url;
          a.download = "EDGBL-LTD-USD_iBanFirst.pdf";
          document.body.appendChild(a);
          a.click();
          window.URL.revokeObjectURL(url);
        });
