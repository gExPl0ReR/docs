...
description: "Top up your EDIS Global account credit balance by bank transfer. Step-by-step guide covering payment details, processing time, and confirmation steps."
---
...
To begin, log in to your [client dashboard](https://manage.edisglobal.com/clientarea.php?action=addfunds) and navigate to **Billing** then click on **Add Funds**. This function allows you to generate a top-up invoice which is necessary for the proper processing and tracking of your payment.
