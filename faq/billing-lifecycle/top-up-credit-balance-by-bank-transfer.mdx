...
To begin, log into your [Client Portal](https://manage.edisglobal.com/clientarea.php?action=addfunds) and navigate to **Billing** then click on **Add Funds**. This function allows you to generate a top-up invoice which is necessary for the proper processing and tracking of your payment.
