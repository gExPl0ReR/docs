...
If you accidentally create one (or even multiple) top-up pro forma invoice, we automatically cancel these documents after approximately 36 hours. You don't need to be concerned about these, we'll take care of them automatically.