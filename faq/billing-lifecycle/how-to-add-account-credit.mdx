...
- To avoid underpayment issues with crypto currency, it’s better to slightly **overpay** rather than risk being short by a small amount. **Overpayments** are automatically forwarded to your account balance.
- **Underpayments will require an additional payment** to get the full amount credited.

## Cancel top-up invoices

If you accidentally create one (or even multiple) top-up pro forma invoice, EDIS Global automatically cancels these documents after approximately 36 hours. You don't need to take any action. We'll take care of them automatically.