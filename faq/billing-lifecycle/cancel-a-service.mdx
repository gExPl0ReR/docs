...
og:description: VPS can be cancelled at any time through the KVM management portal. Users need to login to the VPS Management Portal, locate the VPS in the Services tab, and click "Request Cancellation".
---
