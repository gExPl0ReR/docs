...
## OS Options Available in the Dashboard (Auto-Install)
...
- Cloud-Init custom configurations
...
- [How to Install a Custom OS via VNC](/vps-management/custom-os-vnc)
- [Cloud-Init Quickstart Guide](/vps-management/cloud-init)
- [Reinstalling Your VPS](/vps-management/reinstall)
