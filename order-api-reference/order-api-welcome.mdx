...
description: "Overview of the EDIS Global Order API endpoints for ordering, configuring, and managing VPS services."
---
...
👉 For actual implementation, always start with the **Complete Guide**.