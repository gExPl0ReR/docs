...
- **POST** `/kvm/v2/add/order`
  ...
  [Learn more](order-api-reference/order-vps)
...
- **POST** `/kvm/v2/get/products`
  ...
  [Learn more](order-api-reference/get-vps-plans)
...
- **POST** `/kvm/v2/get/locations`
  ...
  [Learn more](order-api-reference/get-vps-locations)
...
- **POST** `/kvm/v2/get/billingcycles`
  ...
  [Learn more](order-api-reference/get-billing-cycles)
...
- **POST** `/kvm/v2/get/paymentmethods`
  ...
  [Learn more](order-api-reference/get-payment-options)
...
- **POST** `/kvm/v2/get/serviceid`
  ...
  [Learn more](order-api-reference/get-service-id)
...
- **POST** `/kvm/v2/get/kvmid`
  ...
  [Learn more](order-api-reference/get-kvm-id)
...
- **POST** `/kvm/v2/cancel/product`
  ...
  [Learn more](order-api-reference/cancel-vps)
