...
#### November 11, 2025 — Global Database Cluster Upgrade ⚡➡️ Real-Time EDIS
...
- **Resilient traffic-pool logic**: Traffic accounting and quota adjustments now run with increased stability and real-time precision.  
