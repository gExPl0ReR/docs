...
<Update label="March 2025">
  ...
  The key difference between the **“vorher”** (before) and **“jetzt”** (now) structure is a shift from an **unstructured HTML string** to a **structured, machine-readable object**.
  ...
  **💡 Why this change is good**
  ...
  If you’re planning future API enhancements, this structure sets you up nicely for automated plan comparisons, filters, or dynamic UIs. Let me know if you’d like a pretty-printer or rendering function for this\!
