---
title: "How to reset root password for Linux OS"
sidebarTitle: Reset root password for Linux OS
description: "Discover how to securely reset the root password on Ubuntu, Debian, CentOS, and other popular Linux distributions."
---
...
3. ISO will be loaded automatically, Wait when ISO is loaded:

   ![1](/assets/uLxSPwfKVMf9QP5wS5E-loadiso.png)

4. Once the ISO has successfully loaded, you will be prompted to change the password:

   ![2](/assets/tXo35rruULtcDq5XS2w-Enter-new-root-password.png)
