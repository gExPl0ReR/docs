...
- Windows Server version (2019, 2022, 2025, or later) (180-day trial).
...
Under **IP address**, select the server's IP address or select **All Unassigned**.
...
Under **SSL**, you can select one of the following:&#x20;
...
Select **Read** or **Read/Write** permissions, depending on whether you want users to upload files or only download them.
...
3. Select **Port**, enter port 21 for FTP, and follow the prompts to allow inbound traffic.
...
1. In **IIS Manager**, select your FTP site and click **FTP Firewall Support**.
