...
description: "Register a new domain with a third-party registrar and assign it to your KVM VPS. Step-by-step guide covering DNS records, A/AAAA setup, and propagation."
---

## Introduction

If you wish to enhance your online presence with a unique domain name, this guide walks you through the process of domain registration and linking it to your VPS.
...
3. Complete the purchase, ensuring that DNS hosting is included in your domain plan. Alternatively, you can use [Cloudflare DNS](https://www.cloudflare.com/en-gb/application-services/products/dns/), which is AnyCast and free of charge.

## Step 2: link the domain to your VPS

**Locating Your VPS IP Address:**
EDIS Global provides your VPS IP address upon the activation of your KVM VPS plan. You can also find it in the VPS Management Portal.
...
**A1:** Your VPS IP address is included in the welcome email from EDIS Global when you first set up your KVM VPS, and it is displayed in the VPS Management Portal.
