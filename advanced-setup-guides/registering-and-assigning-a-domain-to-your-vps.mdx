...
sidebartitle: Assign Domain to KVM VPS
...
3. Complete the purchase, ensuring that DNS hosting is included in your domain plan. Alternatively, you can use [Cloudfare DNS](https://www.cloudflare.com/en-gb/application-services/products/dns/), it is AnyCast + free of charge.
