...
description: "Install and configure the AmneziaWG WireGuard client on Windows. Transfer your config from Linux and connect to a stealth VPN to bypass DPI restrictions."
---
...
1. **Download AmneziaWG:**

   * Visit the official [AmneziaWG website](https://amnezia.org/en/downloads) and download the latest version of the software suitable for Windows.
...
2. **Import the Configuration File:**
   ...
   * In AmneziaWG, click on "Import Configuration" and browse to the location where you saved the `.conf` file.
