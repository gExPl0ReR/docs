...
### 3. Copy amneziawg config on Linux(Ubuntu):
...
### 4. Get Your WireGuard Configuration
...
### 5. Move Configuration to AmneziaWG Directory
...
### 6. Start the WireGuard VPN Connection
...
### 9. Optionally Enable WireGuard on Boot
