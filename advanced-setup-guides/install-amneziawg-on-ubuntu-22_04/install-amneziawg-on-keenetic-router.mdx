...
If you get insufficient memory to install all select components in a new window that appears during the system update, click to View changes and disable components. Uncheck the unnecessary components to free up memory.
...
Then execute **system configuration save** into the web version of the router's command line, and click the "Send request" button.
