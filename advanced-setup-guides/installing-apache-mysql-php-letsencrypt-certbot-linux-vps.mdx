...
description: "Set up Apache, MySQL, and PHP for a custom domain on a Linux VPS, secured with a Let's Encrypt SSL certificate using Certbot on ports 80 and 443."
---
