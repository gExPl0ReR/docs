...
description: "Extend a Windows Server volume after a VPS plan upgrade or Drive Size Boost using Server Manager, Disk Management, or DiskPart."
---
...
Use this guide after a VPS plan upgrade or after adding up to **400 GB** with Drive Size Boost. EDIS Global enlarges the virtual drive; Windows does not automatically extend the existing partition.
...
2. Click **Volumes** to display all configured drives on your server.
