...
Reinstall your VPS with a clean Linux or Windows image using the **Reinstall OS** feature in your [EDIS Global Client Portal](https://manage.edisglobal.com/clientarea.php).  
