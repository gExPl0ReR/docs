...
Reinstall your VPS with a clean Linux or Windows image using the **Reinstall OS** feature in your [EDIS Global VPS Management Portal](https://manage.edisglobal.com/clientarea.php).  
...
If you previously relied on Turnkey images for fast deployments, we recommend switching to **Cloud-Init templates** or the **Reinstall OS** feature — both offer faster, more reliable, and up-to-date installations.