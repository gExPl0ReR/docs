...
description: "EDIS Global does not offer desktop enabled Debian or Ubuntu images, but you can install Ubuntu 22.04 and enable the GUI via a few shell commands."
---
