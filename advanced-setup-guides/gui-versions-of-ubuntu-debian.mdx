...
og:description: EDIS does not offer a dedicated Debian or Ubuntu images with the a desktop enabled, but users can install Ubuntu 22.04 and enable the GUI via a few shell commands.
---
