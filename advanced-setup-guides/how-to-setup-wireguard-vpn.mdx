...
After following the on-screen questions like SSH key, DNS, etc., it will ask you to run the playbook, and you answer **YES:**
...
<Note>
  ...
  provided domain was `mydomain.com`, your web UI will be
...
It will present you with a QR code you can scan and add to your 2FA application. After a successful login, you will see a web UI where you can add users to your new Wireguard VPN server.
