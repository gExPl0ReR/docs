...
Now that you have your new EDIS Global VPS server up and running, connect to it from the terminal of your preference. On Windows, you can use <a href="https://www.putty.org/" target="_blank">Putty</a>, for example. Then type:
