...
- For Flow settings choose <b>xtls-rprx-vision</b>
  ...
  . The Flow will be visible after activation Reality for Security setting. <img src="/assets/3x-ui-addinbound.png" alt="addinbound" />
...
- Click to Generate New Cert <img src="/assets/3x-ui-addinbound2.png" alt="addinbound2" />

Activate Sniffing, switch to enable: <img src="/assets/3x-ui-addinbound3snifingenable.png" alt="addinbound3snifingenable" /> After entering the data, click the Create button.

If configured correctly, you will have an entry with the protocol. Try to click on the <b>+</b>

 plus to show client settings for export: <img src="/assets/3x-ui-inboundcreated.png" alt="inboundcreated" />

In the drop down menu click to the QR code image: <img src="/assets/3x-ui-qrcodeclick1.png" alt="qrcodeclick1" />

In the pop-up window you’ll see two QR codes. Click the QR code on the right (the VLESS one) and its client configuration will be copied to your clipboard. Then paste this config into your VPN client on your PC or Mobile device. <img src="/assets/3x-ui-QRcode2.png" alt="QRcode2" />
