...
- For Flow settings select <b>xtls-rprx-vision</b>

  . The Flow will be visible after activating Reality for the Security setting.
...
If configured correctly, you will have an entry with the protocol. Try to click the <b>+</b>

 plus to show client settings for export:
