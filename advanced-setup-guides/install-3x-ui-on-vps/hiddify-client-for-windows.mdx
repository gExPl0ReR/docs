...
description: "Connect to a VLESS VPN on Windows using the Hiddify client. Step-by-step setup, configuration import, and tips for bypassing Deep Packet Inspection."
---
...
3. After installing Hiddify, go to its install folder (usually <u> C:\Program Files\Hiddify\ </u>), right-click on **Hiddify.exe** and select Properties, then open the Compatibility tab in the window that appears.
...
6. Go to the main Hiddify screen and click the Profiles icon on the left sidebar to open the profile management section:
...
8. Go to the main Hiddify screen and click the **New Profile** button:
...
10. At the top of the window, you should see the name of your VPN profile if the configuration was imported correctly. To connect to the VPN and check the connection, just click the **Tap to Connect** button: 
