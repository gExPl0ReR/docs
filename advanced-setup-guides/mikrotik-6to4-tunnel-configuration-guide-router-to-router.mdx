...
description: "Learn how to configure a 6to4 tunnel between two MikroTik routers to enable IPv6 connectivity over IPv4 with IPsec encryption."
---
...
> **Important:** This note is for informational awareness only.  
...
> Always comply with local regulations and your provider’s acceptable use policy.
