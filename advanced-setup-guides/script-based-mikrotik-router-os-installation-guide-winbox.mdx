...
8. Check you [**Network Information**](https://docs.edisglobal.com/vps-management/ip-address-information#ip-settings,-network-info) in the billing panel. Configure your IP address of the server (__192.168.1.100__ - IP address of the server & __ether1__ - name of interface):

```bash
 /ip address add address=192.168.1.100/24 interface=ether1 
```

9. Configure gateway(__192.168.1.1__ - IP address of gateway):
