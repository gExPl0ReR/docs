...
8. Check your [**Network Information**](https://docs.edisglobal.com/vps-management/ip-address-information#ip-settings,-network-info) in the billing panel. Configure the IP address of the server (**192.168.1.100** - IP address of the server & **ether1** - name of interface):
