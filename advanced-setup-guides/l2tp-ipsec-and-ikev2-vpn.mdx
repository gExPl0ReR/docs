...
description: "Build an L2TP/IPsec and IKEv2 VPN server on Ubuntu 22.04 with the hwdsl2/setup-ipsec-vpn scripts for flexible, encrypted connections on an EDIS VPS."
---
...
4. **Configure IPsec Settings:**
   ...
   * **Enable IPsec tunnel to L2TP host:** Select this checkbox.
...
5. **Client Authentication:**
   ...
   * **Authentication:** Select **Certificate (/private key)**.
...
6. **Options Configuration:**
   ...
   * **Request an inner IP address:** Select this checkbox.

7. **Cipher Proposals (Algorithms):**

   * **Enable custom proposals:** Select this checkbox.
