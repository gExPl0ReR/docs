...
description: "Deploy a cloud-init .qcow2 image to an EDIS Global VPS using Oracle Linux 8 as a worked example, with notes on user-data, SSH keys, and first-boot config."
---
...
3. Open the KVM management portal select **Reinstall OS** -> select **Custom Cloud-Init Images** (third tab).
