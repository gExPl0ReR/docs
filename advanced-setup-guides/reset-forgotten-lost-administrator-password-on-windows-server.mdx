...
og:description: Learn how to reset the Administrator password for a Windows Server. This step-by-step guide includes Starting the Windows Installer, activating VNC access, loading the Virtio driver, accessing the command prompt, and resetting the password.
---
...
1. _When drives are displayed, do not click on the next button! Otherwise, you will start the reinstall process of the system and all the data will be wiped!_
