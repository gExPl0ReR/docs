---
title: How to set up OpenVPN over Stunnel
description: "Set up OpenVPN over Stunnel on Ubuntu 22.04 to disguise OpenVPN traffic as TLS. Step-by-step guide for stealth VPN deployment that bypasses DPI filters."
---
...
Install Stunnel, which you will use to create an SSL tunnel for OpenVPN traffic.
...
### 6. Enable and start the Stunnel service
...
### 3. Enable and start the Stunnel service
