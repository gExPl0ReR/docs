...
description: "Solution to extend the validity of a Windows trial version using this simple command in PowerShell"
---
...
Open PowerShell with administrative privileges. Run the following command **to view the current licensing status**:
