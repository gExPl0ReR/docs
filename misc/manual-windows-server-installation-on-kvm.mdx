...
description: This document is a rough guide for manually installing Windows Server on EDIS KVM using VNC. The purpose of this doc is to showcase the process. Please use our Auto-Installers!
---
