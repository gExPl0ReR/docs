...
description: "Rough guide for manually installing Windows Server on EDIS KVM via VNC. The process is illustrative — for production, use the EDIS Global Auto-Installers."
---
...
We created this guide to document the process. You _can_ do it this way if you are interested in experimenting. If you want to quickly install Windows or Linux, please use the provided auto-installers.
...
<CtaButton
  ...
  link='../vps-management/autoinstall-reinstall-install-vps-linux-windows'
/>

This manual guides you through a **manual installation** of Windows Server editions 2016, 2012 / R2, 2012, 2008, 2008 / R2. This guide **does not work** if you have a **Windows Desktop .iso** file.
...
![Manual Windows Server installation on EDIS KVM](/assets/wmFZZS9lrK-cn-pukWMnI_manual-windows-server-installation-73d4035424.png)
...
![Manual Windows Server installation on EDIS KVM](/assets/1X9oVnZ2JgRsk_cQIY3iK_manual-windows-server-installation-2-6d3974af2a.png)
...
![Manual Windows Server installation on EDIS KVM](/assets/Oua5O2cnO-l2geiD9lpRU_manual-windows-server-installation-3-29a2db7fd3.png)
...
![Manual Windows Server installation on EDIS KVM](/assets/6oW-8dqGMMyn6Rg0SFyI-_manual-windows-server-installation-4-e7954e59a1.png)
...
![Manual Windows Server installation on EDIS KVM](/assets/WOSth5cRKQN6a-PS6dtnh_manual-windows-server-installation-5-3c500ef3e7.png)

Repeat the process in the "**viostor**" folder.

![Manual Windows Server installation on EDIS KVM](/assets/78a2aEUvvGM8IEgURYjjs_manual-windows-server-installation-6-18cba245f1.png)

Click "**Next**"

![Manual Windows Server installation on EDIS KVM](/assets/-iOJMjSbldw1HKGyhc1A7_manual-windows-server-installation-7-506d75da29.png)
...
IP addresses, subnet mask, gateway address, and nameservers are displayed in your VPS Management Portal.
