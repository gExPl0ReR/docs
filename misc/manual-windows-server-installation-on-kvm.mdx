...
This guide was created to document the process. You _can_ do it this way if you are interested in experimenting. If you want to quickly install Windows or Linux, please use the provided auto-installers.
