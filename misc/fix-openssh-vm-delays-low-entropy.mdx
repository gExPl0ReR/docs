...
description: "Fix OpenSSH startup delays on virtual machines caused by low entropy. Feed entropy from the host using VirtIO RNG or other methods to improve VM responsiveness."
---
