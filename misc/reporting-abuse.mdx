...
If you notice that EDIS services are being used in a way that goes against our policies or any applicable law, please let us know by sending an abuse notification to **abuse@edisglobal.com**. EDIS abuse department makes sure to act timely on all notifications it receives.
