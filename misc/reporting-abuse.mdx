...
If you notice that EDIS services are being used in a way that goes against their policies or any applicable law, please let them know by sending an abuse notification to **abuse@edisglobal.com**. EDIS abuse department makes sure to act timely on all notifications it receives.
