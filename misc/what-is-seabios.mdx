---
title: "What is SeaBIOS on an EDIS Global VPS"
sidebarTitle: "Seabios"
description: "What SeaBIOS is and why you may briefly see it when booting an EDIS Global VPS. Explanation of the open-source x86 BIOS firmware used in KVM virtualization."
---
...
2. **Select Boot Device**: Use the arrow keys to select the desired boot device (e.g., CD-ROM, hard disk) and press `Enter`.
