...
description: "Recover a Linux VPS that fails to boot or has connectivity issues using SystemRescueCD to fix network configurations, firewall rules, and SSH problems."
---

## What is a rescue CD and why use it?
...
You can find your assigned IP information at [VPS IP address settings](/vps-management/ip-address-information).
...
## Check the firewall from rescue mode
...
Rescue mode gives you full control to recover your server. You can fix network issues and firewall rules, restore SSH access, and check essential system settings.