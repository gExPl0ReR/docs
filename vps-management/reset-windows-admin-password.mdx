...
```
   Where:
   \- `Administrator` is the Administrator account in Windows that has full system control -`newstrongpassword` is a new password. ![Reset Windows Password](/assets/q7wiAyHP8mf8iXnKbh1HU_newpassword.png)
