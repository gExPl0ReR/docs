...
Once the password is reset, make sure to [unmount the ISO](https://docs.edisglobal.com/enable-vnc-server) (1_Password-Reset-Helper.iso) image. This can be done in the KVM management portal.
