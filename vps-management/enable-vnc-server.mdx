...
### How to activate VNC in the VPS Management Portal

Through the VPS Management Portal, you can enable VNC for each VPS individually. Once VNC is turned on, **noVNC** or a **desktop VNC client** can be used to connect.
