...
This opens a **virtual console** for your server.
The VNC password is for Desktop VNC Client connections only.
The password is not required for noVNC Console access.
Use your OS username & password to log in once inside.
