...
description: "Enable VNC for an individual VPS in the EDIS Global VPS Management Portal to control the server graphically through noVNC or a desktop VNC client."
---
...
noVNC provides a convenient way to access VNC servers from any device through almost any modern web browser, with no dedicated client software needed. It has some limitations compared to a desktop VNC client, though.

### How to activate VNC in the control panel

Through the VPS Management Portal, you can enable VNC for each VPS individually. Once VNC is turned on, you can connect using **noVNC** or a **desktop VNC client**.
