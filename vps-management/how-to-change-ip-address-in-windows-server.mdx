...
Still looking for a VPS with Windows?
Pick a model with 2vCPU and select Windows OS during checkout.
<CtaButton label="order Windows VPS" link="https://www.edisglobal.com/#start-now" />