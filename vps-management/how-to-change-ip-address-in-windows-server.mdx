...
Here’s a revised guide on how to change the IP address on Windows Server, specifically tailored for you when you’re connected via VNC.

## Change IP address on Windows server

Enable your VNC server: Follow the instructions 
