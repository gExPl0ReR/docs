...
description: "Change the IP address on a Windows Server VPS using Network Connections or PowerShell. Step-by-step guide covering static IP, gateway, and DNS configuration."
---
...
This guide shows you how to change the IP address on Windows Server while you're connected via VNC.
...
<Steps>
  <Step title="Log in to the VPS Management Portal">
    Open the [VPS Management Portal](https://manage.edisglobal.com/clientarea.php).
  </Step>
  <Step title="Enable your VNC server">
    Follow the instructions in [Enable VNC server](/vps-management/enable-vnc-server).
  </Step>
  <Step title="Open VNC">
    - Press `Ctrl + Alt + Delete` to open the Windows login page. You can also use the top key (send CtrlAltDelete). Enter your username and password.
  </Step>
</Steps>
...
![Change IP (Windows)](/assets/1sSq3fI0sZJj8Zc4RoSr4-9mrOC1yNl1bI3VFtxq2NR-20241106-143431.png)
...
![Change IP (Windows)](/assets/1sSq3fI0sZJj8Zc4RoSr4-DMYYt30jBazsPxUj7AJlB-20241106-143450.png)
...
![Change IP (Windows)](/assets/1sSq3fI0sZJj8Zc4RoSr4-aKYYiaZFGWrDXcuNvHt2Q-20241106-143634.png)
...
![Change IP (Windows)](/assets/1sSq3fI0sZJj8Zc4RoSr4-7e4qsQlMtqcneRYQoPZQp-20241106-143711.png)
...
![Change IP (Windows)](/assets/1sSq3fI0sZJj8Zc4RoSr4-4BhxXEhIHXelTu7FLG9lc-20241106-143733.png)
