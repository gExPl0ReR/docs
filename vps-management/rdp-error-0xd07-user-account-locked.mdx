...
In many cases, this is **not caused by you directly**.

Automated bots constantly scan public RDP services, attempting brute-force logins against Windows servers connected to the internet.
...
If you recently changed your password, remove any old saved credentials.
