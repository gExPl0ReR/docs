...
## OS options available in the VPS Management Portal (Auto-Install)

🖥️  After your VPS is deployed, the **VPS Management Portal → Auto-Install** section provides a **much broader** OS selection.
...
### **VPS Management Portal = full flexibility**
...
| Feature                    | Shopping Cart | VPS Management Portal Auto-Install |
| -------------------------- | ------------- | -------------------------- |
| Modern OS versions         | ✔             | ✔                          |
| Older LTS releases         | —             | ✔                          |
| Ubuntu 16.04               | —             | ✔                          |
