...
description: "Each EDIS Global VPS receives a dedicated /64 IPv6 subnet. Configure additional IPv6 addresses or change the default per OS with the examples in this guide."
---

## IPv6 address, subnet mask

EDIS automatically assigns each VPS its own /64 IPv6 subnet. An IPv6 address from the assigned subnet is statically preconfigured on the interface.
...
To enable external IPv6 communication, you must configure a default route or default gateway.
