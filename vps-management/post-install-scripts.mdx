...
description: "Post-install scripts have been removed from the EDIS Global Auto-Installer. Use Cloud-Init user_data instead to automate VPS setup on first boot reliably."
---
...
Below are historical examples of Post-Install Scripts. They are **no longer supported**, but are shown here to help you understand legacy configurations or migrate to Cloud-Init equivalents.
...
The example post-install script below installs a simple firewall.
...
The following script performs several actions on an RPM-based OS (RHEL, Fedora, CentOS, openSUSE, SLES, Oracle Linux, Rocky Linux, AlmaLinux)
...
These examples illustrate a spectrum of automated tasks you can accomplish with EDIS Global's post-install scripts, making server setup and management more efficient and error-free. By crafting tailored scripts, you can significantly streamline your deployment processes and operational workflows on our VPS Hosting.