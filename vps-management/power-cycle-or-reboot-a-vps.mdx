...
og:description: The document explains how to power-cycle or reboot a Virtual Private Server (VPS) through the KVM management portal or using a shutdown command followed by a power on through the portal.
---
