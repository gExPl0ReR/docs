...
Once the operating system has shut down completely, start the VPS again using the **START** button in the KVM management portal. This is the preferred way to perform a clean cold boot and helps prevent filesystem corruption or data loss.
