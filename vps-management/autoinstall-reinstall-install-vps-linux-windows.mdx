...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align:left;">Port Behavior</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td style="text-align:center;">
        <img src="/assets/huaNpFAxK5PVCl_NLo3ID-qDPCEUD7wtL6EYnFUKOfe-20241001-201404.png" alt="Linux install 5 min" width="52">
        <div>≈ 5 min</div>
        <div style="font-size:0.85em;color:#666;">Auto-install in progress</div>
      </td>
      <td>SSH <strong>22</strong> is closed during installation.</td>
    </tr>
    <tr>
      <td><strong>Windows</strong></td>
      <td style="text-align:center;">
        <img src="/assets/huaNpFAxK5PVCl_NLo3ID-ozGQ3EbLw2SKc3sattPPn-20241001-201443.png" alt="Windows install 15 min" width="52">
        <div>≈ 15 min</div>
        <div style="font-size:0.85em;color:#666;">Preparing Windows image</div>
      </td>
      <td>RDP <strong>3389</strong> is closed during installation.</td>
    </tr>
  </tbody>
</table>
