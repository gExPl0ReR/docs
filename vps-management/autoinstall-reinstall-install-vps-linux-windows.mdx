...
|-----------|----------|-------------------------------------------|
| **Linux** | ≈ 5 min  | SSH **22** is closed during installation. |
| **Windows** | ≈ 15 min | RDP **3389** is closed during installation. |

**Visual reference**

**Linux (≈ 5 min)**  
![Linux install icon](/assets/huaNpFAxK5PVCl_NLo3ID-qDPCEUD7wtL6EYnFUKOfe-20241001-201404.png)

**Windows (≈ 15 min)**  
![Windows install icon](/assets/huaNpFAxK5PVCl_NLo3ID-ozGQ3EbLw2SKc3sattPPn-20241001-201443.png)
