...
<Note>
  During reinstallation, **remote access (SSH/RDP)** is temporarily disabled while your VPS is being rebuilt. You’ll be able to connect once the installation has finished — typically after **≈ 5 minutes for Linux** or **≈ 15 minutes for Windows**. ⚠️ **Do not power off or reboot your VPS** during this time, as it may interrupt the OS setup.
</Note>
