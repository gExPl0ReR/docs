...
The image below shows the typical duration and port behavior for each operating system:

<figure style={{ textAlign: "center" }}>
  <img
    src="/assets/windows-linux-install-time-ports-closed.png"
    alt="Linux and Windows VPS installation time and port behavior"
    style={{ maxWidth: "100%", borderRadius: "8px", margin: "0 auto" }}
  />
  <figcaption style={{ color: "#666", fontSize: "0.9em", marginTop: "6px" }}>
    Typical Auto-Install durations and temporary port behavior for Linux and Windows.
  </figcaption>
</figure>
