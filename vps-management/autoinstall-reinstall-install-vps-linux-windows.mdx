...
Whether you’re switching from Linux to Windows or simply starting fresh, the **ReiReinstall OS** feature lets you rebuild your VPS quickly and securely.
...
<Steps>
  ...
  <Step title="Click “ReiReinstall OS”">
...
<Note>
  ...
  If you just need a clean Linux or Windows environment, the **ReiReinstall OS** option is simpler and faster.
</Note>
