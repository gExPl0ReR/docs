---
title: "System Configuration Dialog for EDIS Global VPS"
sidebarTitle: "System Configuration"
description: "Configure CPU, disk, network, video, and VLAN settings in the EDIS Global VPS System Configuration dialog for optimal performance, compatibility, and stability."
---

## ⚙️ System configuration dialog in VPS Management PortaManagement PortaManagement Portal ⚙️ System configuration dialog in VPS Management Portal
...
The System Configuration allows you to control:

- **Boot Mode:** BIOS or UEFI
- **TPM:** Disabled or Software TPM (vTPM)

### Default behavior

- **BIOS** and **TPM disabled** are the default settings for maximum compatibility.

### Important

- Many operating systems are **not compatible with UEFI**
- Some modern systems (e.g. Windows 11) **require UEFI \+ TPM**

### How settings are applied

- **Auto-installers** automatically select the correct configuration
- Manual settings are mainly relevant when:
  - using **custom images**
  - booting from **ISO**
...
- **Host CPU Passthrough** – Passes the host's actual CPU features (like AES, SSE3, SSE4.1, SSE4.2, etc.) to the VPS for better performance. This especially benefits workloads that can utilize advanced instruction sets.
...
> 📖 [Mikrotik CHR installation guide](https://docs.edisglobal.com/advanced-setup-guides/script-based-mikrotik-router-os-installation-guide-winbox)
...
📖 [Learn more about VNC](https://docs.edisglobal.com/vps-management/enable-vnc-server#understanding-vnc).

---

## 📝 Description

This is a free-text field where you can label your VPS with a custom name or note. It helps you organize and identify your servers in the Client PortalClient PortalClient Portal. This is a free-text field where you can label your VPS with a custom name or note. It helps you organize and identify your servers in the Client Portal.
