...
Click on the **Connect** button. Enter the server password and check the box "Remember me".
...
Double-click the newly created connection (tile) and confirm the certificate warning (**Continue**)
