...
| Add RAM, vCPU, storage or IPv4 addresses | [Upgrade your VPS](#upgrade-your-vps) |
...
You can move to a higher plan or add individual resources without reinstalling the operating system. Current configurable additions are up to **24 GB RAM**, **8 vCPU cores**, **400 GB Drive Size Boost**, and **10 additional IPv4 addresses** per VPS.

Open the VPS under **Services**, go to **Configurable Options**, and select **Upgrade Resources**. Drive Size Boost is added to the storage already included with the plan; a 100 GB plan plus the maximum 400 GB boost provides a 500 GB virtual drive.
